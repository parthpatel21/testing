...
function imageMode(color){
    image1.src=`img/undraw_business_decisions_gjwy_${color}.svg`
    image2.src=`img/undraw_online_message_xq4c_${color}.svg`
    image3.src=`img/undraw_watch_application_uhc9_${color}.svg`
}
